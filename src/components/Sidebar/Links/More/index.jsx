...
const More = () => {
  return (
    <Popover className="relative  w-[318px] ">
      <Popover.Button className="flex items-center justify-start w-full outline-none group">
        <div className=" rounded-full pr-5 pl-1 py-3 inline-flex items-start justify-start gap-5 group-hover:bg-[#eef3f41a] ">
          ...
          <p className="text-[19px]">Daha Fazla</p>
        </div>
      </Popover.Button>

      <Popover.Panel className="absolute bottom-0 z-50 w-full p-3 overflow-hidden bg-black -left-20 shadow-box rounded-xl">
        <button className="flex items-center justify-start w-full group">
          <div className=" pr-5  py-3 flex items-start justify-start gap-5 group-hover:bg-[#eef3f41a] transition-colors  w-full">
            <svg viewBox="0 0 24 24" width={26.25} height={26.25} fill="#fff">
            ...
            <p className="text-[19px]">Bağlan</p>
          </div>
        </button>
        <button className="flex items-center justify-start w-full border-b border-gray-700 group">
          <div className=" pr-5  py-3 flex items-start justify-start gap-5 group-hover:bg-[#eef3f41a] transition-colors  w-full">
            <svg viewBox="0 0 24 24" width={26.25} height={26.25} fill="#fff">
            ...
            <p className="text-[19px]">Para Kazanma</p>
          </div>
        </button>
        <Disclosure>
          <Disclosure.Button className="flex items-center justify-between w-full px-2 py-4 transition-colors hover:bg-[#eef3f41a]  text-start">
          ...
          <Disclosure.Panel className="text-gray-500">
            <button className="flex items-center justify-center w-full group">
              <div className=" pr-5  py-1 flex items-center justify-start gap-5 group-hover:bg-[#eef3f41a] transition-colors  w-full">
                <svg viewBox="0 0 24 24" width={15} height={15} fill="#fff">
                  <path d="M8.75 21V3h2v18h-2zM18 21V8.5h2V21h-2zM4 21l.004-10h2L6 21H4zm9.248 0v-7h2v7h-2z" />
                </svg>
                <p className="text-md">İstatistikler</p>
              </div>
            </button>
          </Disclosure.Panel>
        </Disclosure>
          ...
          <Disclosure.Panel className="text-gray-500">
            <button className="flex items-center justify-center w-full group">
              <div className=" pr-5  py-1 flex items-center justify-start gap-5 group-hover:bg-[#eef3f41a] transition-colors  w-full">
                ...
                <p className="text-md">Reklamlar</p>
              </div>
            </button>
          </Disclosure.Panel>
        </Disclosure>
          ...
          <Disclosure.Panel className="text-gray-500">
            <button className="flex items-center justify-center w-full group">
              <div className=" pr-5  py-1 flex items-center justify-start gap-5 group-hover:bg-[#eef3f41a] transition-colors  w-full">
                ...
                <p className="text-md">Ayarlar ve Gizlilik</p>
              </div>
            </button>
            <button className="flex items-center justify-center w-full group">
              <div className=" pr-5  py-1 flex items-center justify-start gap-5 group-hover:bg-[#eef3f41a] transition-colors  w-full">
                ...
                <p className="text-md">Yardım Merkezi</p>
              </div>
            </button>
            <button className="flex items-center justify-center w-full group">
              <div className=" pr-5  py-1 flex items-center justify-start gap-5 group-hover:bg-[#eef3f41a] transition-colors  w-full">
            ...
            <button className="flex items-center justify-center w-full group">
              <div className=" pr-5  py-1 flex items-center justify-start gap-5 group-hover:bg-[#eef3f41a] transition-colors  w-full">
                ...
                <p className="text-md">Klavye Kısayolları</p>
              </div>
            </button>
          </Disclosure.Panel>
        </Disclosure>
