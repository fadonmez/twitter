...
const Links = () => {
  ...
  return (
    <div className="flex flex-col w-full gap-1 px-2 mt-2 ">
      {menuLinks.map((item) => {
        return (
          <NavLink
            key={item.name}
      ...
      <More />
      <button className="px-4 py-3 mt-3 font-bold text-white transition-opacity bg-blue-500 rounded-full hover:opacity-80">
        Gönder
      </button>
    </div>
  );
